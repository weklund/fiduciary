...
- Income: ~$17,500/month (AWS, National Tobacco, AIBES LLC)
- Two mortgages: $7,034/month (Saint Catherine + 6th St)
- Building a B2B consulting business and a SaaS product (Modus)
- Active trader (options, crypto) — trading tools are business expenses
- Health/biohacking focused — significant wellness spend (Dexcom, Oura, WHOOP, supplements)
- HSA balance: $16K with $4,662 in documented reimbursable expenses
- Fidelity: ~$50K (Amazon stock, Bitcoin, Gold ETF)
- Debt elimination plan in progress (target: September 2026 debt-free excluding mortgages)
