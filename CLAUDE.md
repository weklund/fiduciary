...
<!-- Generated by /onboard — run this skill to populate or update -->
<!-- Personal context is stored in Claude Code memory files, not committed to git -->
...
This conducts a structured intake interview (modeled on the CFP Board's 7-step
fiduciary planning process) and writes your personalized context here and to
